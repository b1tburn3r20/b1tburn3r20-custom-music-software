...
export const useMusicStore = create<MusicStore>((set) => ({
  ...initialState,
  setLikedSongs: (data) => set({ likedSongs: data }),
  ...
  setPlaylistUpdateData: (data: Song | null) =>
    set({ playlistUpdateData: data }),
  setRandomMusic: (randomMusic: Song[]) => set({ randomMusic }),
  setRecentlyPlayed: (recentlyPlayed: Song[]) => set({ recentlyPlayed }),
  setRecentlyDownloaded: (recentlyDownloaded: Song[]) =>
  ...
  setPlaylistDiceIndex: (playlistDiceIndex: number) =>
    set({ playlistDiceIndex }),
  setRecentlyPlayedPlaylists: (recentlyPlayedPlaylists: PlaylistType[]) =>
    set({ recentlyPlayedPlaylists }),
  ...
  removeSong: (song: Song) => {
    (set((state) => ({
      ...
      likedSongs: state.likedSongs.filter((s) => s.path !== song.path),
      recentlyDownloaded: state.recentlyDownloaded.filter(
        (s) => s.path !== song.path,
      ),
  ...
  replacePlaylist: (playlist: PlaylistType) =>
    set((state) => ({
