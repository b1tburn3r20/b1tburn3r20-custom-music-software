...
const PlayingPlaylist = () => {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center bg-black/50 overflow-hidden">
      <div className="max-w-2xl w-full h-full flex flex-col p-6">
        <div className="flex justify-center mb-6 shrink-0">
          <div className="flex flex-col justify-center rounded-xl overflow-hidden items-center h-[300px] w-[300px] border-2">
            <img src={playing?.metadata.thumbnail as string} alt="Playlist" className="w-full h-full object-cover overflow-hidden" />
          </div>
        </div>
        <div className="flex items-center justify-center text-center mb-4 shrink-0">
          <span className="sm:text-sm md:text-md lg:text-xl font-bold">
            <span>

              {playing?.metadata.title}
            </span>
            <Separator className="my-1" />
            <span className="text-sm text-muted-foreground">{activeDir.playlistName}</span>
          </span>
        </div>
